...
extension Color {
  ...
  class func addMaterialColors() {
    ...
    //TODO: have our Realm come baked with this data **BUT** don't import from a CSV. Generate it here, then save that Realm and save the code that generates is as a generator or some crap? Where should we stash it? See how big it is!
    ...
    addColor(withName:"Light Blue",hexes:["E1F5FE","B3E5FC","81D4FA","4FC3F7","29B6F6","03A9F4","039BE5","0288D1","0277BD","01579B","80D8FF","40C4FF","00B0FF","0091EA"])
    ...
    addColor(withName:"Light Green",hexes:["F1F8E9","DCEDC8","C5E1A5","AED581","9CCC65","8BC34A","7CB342","689F38","558B2F","33691E","CCFF90","B2FF59","76FF03","64DD17"])
    ...
    addColor(withName:"Deep Orange",hexes:["FBE9E7","FFCCBC","FFAB91","FF8A65","FF7043","FF5722","F4511E","E64A19","D84315","BF360C","FF9E80","FF6E40","FF3D00","DD2C00"])
    ...
    addColor(withName:"Blue Grey",hexes:["ECEFF1","CFD8DC","B0BEC5","90A4AE","78909C","607D8B","546E7A","455A64","37474F","263238"])
